...
local function tryLogin(charInfo, tries)
  ...
  CharacterList.hide()
  g_logger.info("=== DEBUG LOGIN ===")
  g_logger.info("Account: " .. G.account)
  g_logger.info("Character: " .. charInfo.characterName)
  g_logger.info("World: " .. charInfo.worldName)
  g_logger.info("Host: " .. charInfo.worldHost)
  g_logger.info("Port: " .. charInfo.worldPort)
  g_logger.info("Version: " .. G.clientVersion)
  g_logger.info("==================")
