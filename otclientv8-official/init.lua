-- CONFIG
APP_NAME = "ot7_client"  -- important, change it, it's name for config dir and files in appdata
...
Services = {
  website = "http://181.215.45.238", -- nosso servidor website
  updater = "",  -- desabilitado
  stats = "",
  crash = "",    -- desabilitado
  feedback = "", -- desabilitado
  status = "http://181.215.45.238/login.php"
}

-- Servers accept http login url, websocket login url or ip:port:version
  Servers = {
    ["OT7 Server HTTP"] = "http://181.215.45.238/login.php",
    ["OT7 Server Direct"] = "181.215.45.238:7171:860",
    ["OT7 Server LOCAL TEST"] = "127.0.0.1:7171:860"
  }
