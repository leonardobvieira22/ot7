...
class Database extends PDO
{
	...
	private $db_password;
	private $db_file;
        public function __construct($driver = self::DB_MYSQL, $host = "localhost", $port = "3306", $database = "", $username = "", $password = "")
        {
            ...
            parent::__construct("mysql:host=" . $this->db_host . ";port=" . $this->db_port . ";dbname=" . $this->db_name, $this->db_username, $this->db_password);
        }
	...
	public function executeQuery(string $statement, ?int $fetchMode = null, mixed ...$fetchModeArgs): PDOStatement|false
	{
		$this->queriesCount++;
